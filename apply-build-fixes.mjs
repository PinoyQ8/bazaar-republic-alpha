// Location: apply-build-fixes.mjs
import fs from 'fs';

// 1. Upgrade tsconfig.json to ES2022
...
if (fs.existsSync(tsconfigPath)) {
  try {
    ...
    console.log('✅ 1. tsconfig.json upgraded to ES2022.');
  } catch (err) {
    console.warn('⚠️ Could not parse tsconfig.json:', err.message);
  }
}

// 2. Write the complete Master Schema v2.7.2
const schemaContent = [
  'datasource db {',
  '  provider = "mongodb"',
...
console.log('✅ 2. prisma/schema.prisma written cleanly.');

// 3. Write lib/prisma.ts singleton with dynamic fallback
...
console.log('✅ 3. lib/prisma.ts updated.');