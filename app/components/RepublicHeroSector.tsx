// Location: app/components/RepublicHeroSector.tsx
"use client";
...
export default function RepublicHeroSector() {
  ...
  const handleHandshake = async () => {
    ...
    try {
      ...
      setTimeout(async () => {
        // 🟢 CORRECTED: Feeds a clean, complete PioneerState object to context login to prevent typescript loop crashes
        await login({
          uid: authResults.user.uid,
