...
// ❌ PURGED: import PioneerRecord from '@/models/PioneerRecord'; // (or similar legacy models)

export async function GET(req: Request) {
    console.log("🚀 [MESH-SYNC] Legacy Pioneer-Data route offline for Drizzle migration.");
    ...
    try {
        ...
        return NextResponse.json({ 
            status: "MIGRATING", 
            message: "Pioneer-data engine transitioning to Neon Postgres." 
        }, { status: 200 });
