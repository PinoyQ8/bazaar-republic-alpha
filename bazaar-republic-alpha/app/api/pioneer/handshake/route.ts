...
// ❌ PURGED: import HandshakeRecord from '@/models/HandshakeRecord'; // (or similar legacy models)

export async function POST(req: Request) {
    console.log("🚀 [MESH-SYNC] Legacy Pioneer-Handshake route offline for Drizzle migration.");
    ...
    try {
        ...
        return NextResponse.json({ 
            status: "MIGRATING", 
            message: "Pioneer-handshake engine transitioning to Neon Postgres." 
        }, { status: 200 });
