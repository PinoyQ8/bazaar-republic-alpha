...
// ❌ PURGED: import VoteRecord from '@/models/VoteRecord'; // (or similar legacy models)

export async function POST(req: Request) {
    console.log("🚀 [MESH-SYNC] Legacy Governance Vote route offline for Drizzle migration.");
    ...
    try {
        ...
        return NextResponse.json({ 
            status: "MIGRATING", 
            message: "Governance voting engine transitioning to Neon Postgres." 
        }, { status: 200 });
