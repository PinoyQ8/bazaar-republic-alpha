...
// ❌ PURGED: import ProposalRecord from '@/models/ProposalRecord'; // (or similar legacy models)

export async function POST(req: Request) {
    console.log("🚀 [MESH-SYNC] Legacy Governance Submit Proposal route offline for Drizzle migration.");
    ...
    try {
        ...
        return NextResponse.json({ 
            status: "MIGRATING", 
            message: "Governance proposal submission engine transitioning to Neon Postgres." 
        }, { status: 200 });
