...
export interface Client {
   ...
   */
  init_mesh: ({founder}: {founder: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  execute_sync: ({pioneer}: {pioneer: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABQAAAAAAAAAAAAAAElN5bmNBY3RpdmF0ZWRFdmVudAAAAAAAAQAAABRzeW5jX2FjdGl2YXRlZF9ldmVudAAAAAEAAAAAAAAAB3Bpb25lZXIAAAAAEwAAAAEAAAAC",
        "AAAAAAAAAAAAAAAJaW5pdF9tZXNoAAAAAAAAAQAAAAAAAAAHZm91bmRlcgAAAAATAAAAAA==",
        "AAAAAAAAAAAAAAAMZXhlY3V0ZV9zeW5jAAAAAQAAAAAAAAAHcGlvbmVlcgAAAAATAAAAAA==" ]),
      options
    )
  }
  public readonly fromJSON = {
    init_mesh: this.txFromJSON<null>,
        execute_sync: this.txFromJSON<null>
  }
}